    ...
    public ArrayList<Cliente> listagem() throws Exception {
        try {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                objetoCliente.setRazaoSocial((String) vetorString[2]);
                objetoCliente.setCpf_cnpj((String) vetorString[3]);
...
//                br.close();
//                //return new Cliente(Integer.parseInt(vetorString[0]), vetorString[1], vetorString[2], vetorString[3], vetorString[4], vetorString[5], vetorString[6], vetorString[7], vetorString[8]);
//            }
//
//        }
//        return null;
